// Transport node component for the React Flow canvas.
...
export function TransportNode({ data, selected }: NodeProps<NodeData>) {
  const nodeColor = "#48bb78"
  const isOnPath = data.isOptimalPath
  const borderColor = isOnPath ? "#48bb78" : (selected ? "rgba(99,179,237,0.6)" : "rgba(255,255,255,0.1)")
  const bgColor = isOnPath ? `rgba(72,187,120, 0.12)` : "rgba(22,28,46,0.9)"
