// Trader node component for the React Flow canvas.
...
export function TraderNode({ data, selected }: NodeProps<NodeData>) {
  const nodeColor = "#63b3ed"
  const isOnPath = data.isOptimalPath
  const borderColor = isOnPath ? "#63b3ed" : (selected ? "rgba(99,179,237,0.6)" : "rgba(255,255,255,0.1)")
  const bgColor = isOnPath ? `rgba(99,179,237, 0.12)` : "rgba(22,28,46,0.9)"
